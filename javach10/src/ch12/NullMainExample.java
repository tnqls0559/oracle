...
public class NullMainExample {
	public static void main(String[] args) {
	 ...
	 try {
		  System.out.println(Objects.requireNonNull(str2, new SupplierClass()));
	 }catch(Exception e) {
		 System.out.println(e.getMessage());
	 }	 
	...
	try {
		  System.out.println(Objects.requireNonNull(str2,()->"너얼포인트 오류"));
	 }catch(Exception e) {
		 System.out.println(e.getMessage());
	 }	 
	}
...
/*
	 ...
	 */
/*
 * public interface Supplier<String> { String get(); }
