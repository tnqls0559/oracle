...
public class MathMainExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.rint(5.7));//6.0--실수
		...
		double temp1 = value*100;//두 자리 곱해서 정수로 변환
		long temp2 = Math.round(temp1);//정수 상태에서 반올림
		double v16 = temp2/100.0;//두 자리 나눠서 원래 실수로 변환
