...
public class IndexOfMainExample {
	...
	public static void main(String[] args) {
		String str = "hi hi hi i am a boy";//처음부터 "hi"패턴 찾음
		...
		System.out.println(ssn.indexOf("9"));
		System.out.println(ssn.indexOf("9")>-1?"9가 문자열에 존재":"9가 문자열 내에 없습니다.");
		
		String prg = "Java Programming";
		System.out.println(prg);//그대로
		System.out.println(prg.toUpperCase());//대문자
		System.out.println(prg.toLowerCase());//소문자
